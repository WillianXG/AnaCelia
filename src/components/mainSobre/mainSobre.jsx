...
function MainSobre() {
  const [info, setInfo] = useState({
    horario: "⏰Horário de Funcionamento: Segunda a Sexta: 9h às 21h Sábado: 8h às 13h⏰",
    ...
    endereco : "Av. Dom Hélder Câmara, 5200 - Cachambi, Rio de Janeiro CEP 20771-004 - Sala 925"
  });
